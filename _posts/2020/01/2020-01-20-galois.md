...
$y$ の $G$ における安定化群 $G_y$ を考えると $t = \lvert G \rvert/\lvert G_y\rvert$ なので
...
**補題**：$L/K$ を有限次 Galois 拡大、$M$ を $L/K$ の中間体とする。
...
\mathscr M \ni M_H &\longmapsto H \in \mathscr H.
\end{aligned}
$$
