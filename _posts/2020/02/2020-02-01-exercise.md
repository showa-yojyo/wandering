...
$(24)$ $k$ を標数 $p \ne 0$ の体、$X$ を不定元とする。
体 $k(X)$ の $k(X^p)$ 上の自己同型写像は恒等写像に限る。

**証明**：$X$ の $k(X^p)$ 上の最小多項式は $t^p - X^p = 0.$
...
$$
\begin{aligned}
\alpha^2 &= 2 + 2\sqrt{15}i = (\sqrt{5} + \sqrt{3}i)^2\\
\therefore \alpha &= \sqrt{5} + \sqrt{3}i.
\end{aligned}
$$

最小分解体は $\mathbb Q\left(\alpha\right) = \mathbb Q\left(\sqrt{2 + 2\sqrt{15}i}\right) = \mathbb Q(\sqrt{5} + \sqrt{3}i).$
$\blacksquare$
...
だから急所は $[K(\alpha_1, \dotsc, \alpha_{i}) : K(\alpha_1, \dotsc, \alpha_{i - 1})] \le \text{???}$ か。
...
$[K(\alpha_1, \alpha_2) : K(\alpha_1)]$ は $\alpha_2$ の $K(\alpha_1)$ 上の最小多項式の次数である。
...
**解**：$K = \mathbb Q(\sqrt[3]{2}, \sqrt[3]{2}\omega, \sqrt[3]{2}\omega^2) = \mathbb Q(\sqrt[3]{2}, \omega) = \mathbb Q(\sqrt[3]{2} + \omega).$
なぜなら、

$$
\begin{aligned}
&\operatorname{id}\colon \sqrt[3]{2} \longmapsto \sqrt[3]{2}, & &\omega \longmapsto \omega,\\
&\varphi_1\colon \sqrt[3]{2} \longmapsto \sqrt[3]{2}, & &\omega \longmapsto \omega^2,\\
&\varphi_2\colon \sqrt[3]{2} \longmapsto \sqrt[3]{2}\omega, & &\omega \longmapsto \omega,\\
&\varphi_3\colon \sqrt[3]{2} \longmapsto \sqrt[3]{2}\omega, & &\omega \longmapsto \omega^2,\\
&\varphi_4\colon \sqrt[3]{2} \longmapsto \sqrt[3]{2}\omega^2, & &\omega \longmapsto \omega,\\
&\varphi_5\colon \sqrt[3]{2} \longmapsto \sqrt[3]{2}\omega^2, & &\omega \longmapsto \omega^2,\\
\end{aligned}
$$

上の $\mathbb Q(\sqrt[3]{2}, \omega)$ から $\overline \mathbb Q$ の中への $\mathbb Q$ 準同型写像のいずれに対しても
$\varphi(\sqrt[3]{2} + \omega)$ の像が異なることによる。
$\blacksquare$
